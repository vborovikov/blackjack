namespace Blackjack
{
    ...
    public class Dealer : HandBase
    {
        ...
        public void Play(IList<Hand> hands)
        {
            ...
            var isNatural = this.FirstCard.Score == 1 || this.FirstCard.Score == 10 ? this.IsNatural : false;
        ...
        private IEnumerable<Hand> Play(Hand hand)
        {
    ...
    public class Shoe
    {
        ...
        public static IEnumerable<T> Shuffle<T>(params T[] source)
        {
            return Shuffle(source.AsEnumerable());
        }
